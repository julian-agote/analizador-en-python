...
class G:
        ...
        def demostrarArgumento(self,reduccionAbsurdo=False):
                ...
                while True:
                                ...
                                if (self.arbol[v['ind']]['op']=='conj_dis' and
                                    ...
                                    v['regla']!='RI^'):
                                        ...
                                        if formulas.count({'ind':ind,'regla':'RE^','oper':((i+1),)})==0:
                                                ...
                                                c+=2                                    
                                # regla de eliminacion de la implicacion (modus ponens)
                                elif self.arbol[v['ind']]['op']=='impl':
                                        # ver si existe una formula que coincide con self.arbol[v['ind']]['li']
                                        vj=[]
                        ...
                        if self.iguales(self.premisas[-1],formulas[-1]['ind']) and not hay_disyuncion:
                                final=True              
        ...
        def LeerSigTerm(self):
                ...
                if CarSgte in ('(',')','='):
                        ...
                        lexema += CarSgte
                        token = 'coimpl'                        
                elif CarSgte in [chr(i) for i in range(ord('a'),ord('z'))]+['z']:
                        token = 'prop'
                return (token,lexema)
